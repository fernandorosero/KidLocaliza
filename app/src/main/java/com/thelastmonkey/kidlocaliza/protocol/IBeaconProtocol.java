...
package com.thelastmonkey.kidlocaliza.protocol;
...
public class IBeaconProtocol {
	 ...
	 * El BLE advertisement longitud del prefijo
	 */
	 ...
	 * Periodo de escaneo para buscar iBeacon en milisegundos en este caso 10 segundos
	 */		
	 ...
	 * Estado del proceso de búsqueda de notificar al oyente : iniciado
	 */	
	public static final int SEARCH_STARTED = 1;

	/**
	 * State of the search process to notify the listener: no iBeacons found
	 * Estado del proceso de búsqueda de notificar al oyente : no hay iBeacons encontrados
	 */	
	public static final int SEARCH_END_EMPTY = 2;
	
	/**
	 * State of the search process to notify the listener: at least one iBeacon found
	 * Estado del proceso de búsqueda de notificar al oyente : al menos un IBeacon encontrado
	 */		
